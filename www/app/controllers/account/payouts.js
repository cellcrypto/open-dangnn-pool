...
export default Ember.Controller.extend({
  ...
  chartPayment: Ember.computed('intl', 'model.payments', {
    get() {
        var e = this,
            ...
            a = {
                        ...
                        load: function() {
                            ...
                            setInterval(function() {
                                var x = (new Date()).getDate(),
                                    y = e.getWithDefault("model.payments");
                ...
                tooltip: {
                    formatter: function() {
                        return "<b>" + Highcharts.dateFormat('%Y-%m-%d', new Date(this.x)) + "<b><br>Payment&nbsp;<b>" + this.y.toFixed(4) + "&nbsp;DGN</b>";
                    },
                    useHTML: true
                },
                exporting: {
